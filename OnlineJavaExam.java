...
class OnlineTestBegin extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if (current == 0) {
            l.setText("Que1: Who is known as the father of the Java programming language?");
        ...
        if (current == 1) {
            l.setText("Que2: How many primitive data types are there in Java?");
            jb[0].setText("6");
            jb[1].setText("7");
            jb[2].setText("8");
            jb[3].setText("9");
        ...
        if (current == 2) {
            ...
            jb[2].setText("java.io.package");
            jb[3].setText("java.awt.package");
        }
        if (current == 3) {
        ...
        if (current == 6) {
            l.setText("Que7: When is finalize() method called?");
        ...
        if (current == 7) {
            l.setText("Que8: What is the implict return type of constructo?");
        ...
        if (current == 8) {
            ...
            jb[0].setText("ArithmaticException");
